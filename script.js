function bootstrapApp() {
    ...
    // The sharing rendering logic has been extracted to share.js
    // We expose necessary local helpers to a global context for share.js to use
    window.appContext = {
        resolvePosterUrl,
        getGenreDisplayName,
        HIDDEN_GENRES,
    ...
    async function shareDossierAsImage() {
        ...
        try {
            ...
            await window.ShareModule.shareItem(currentDossierItem);
        } catch (error) {
